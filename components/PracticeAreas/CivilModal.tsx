...
On the contrary, disputes related to property, terms of business, and tenancy matters are different types of civil cases. However, a layman commonly assumes only property disputes to fall under the umbrella of civil matters in the courts. To bring clarity on this aspect, the different types of civil suits in CPC (Civil Procedure Code, 1908) have been explained below. This will bring some clarity on the kind of matters heard and decided by the civil courts in India. <br/>


<span className="font-serif font-bold">What are the 4 Types of Civil Cases as per CPC? </span> <br/>

The different kinds of civil suits mentioned in the Code of Civil Procedure, 1908 have been explained below. The categorization depends upon the nature of disputes/ matters brought in the civil courts.<br/>


<span className="font-serif font-bold">Regular Civil Suit :-</span> <br/>

Suits in general under part 1 of CPC 1908 fall under the category of regular suits. It usually includes disputes related to title, recovery of money, declaration, suit for redemption, rendition of accounts, etc. Also, the pecuniary limit for such matters is less than or equal to Rs 5 lakh. Additionally, in an ordinary or regular suit, the defendant is entitled to defend his/ her case before the court. <br/>


<span className="font-serif font-bold">Special Civil Suit :-</span> <br/>
...
‘Stay orders’ are commonly understood by ordinary people for the purpose of refraining someone from doing a specific act which steps on their rights. Court orders in one of the types of civil cases when parties are required to refrain or do some particular act, are termed as injunction. It is of the following types:<br/>
    ...
    Preliminary injunction (Issued prior to the trial when wrongful action is obvious on the face of application) <br/>
    Temporary Injunction (Issued when status quo is needed for preventing an irreparable damage or to preserve the subject matter during trial)<br/>
    Permanent Injunction (A perpetual order to make a person do or cease from doing a particular act)<br/>


    <span className="font-serif font-bold">Torts :-</span><br/>
...
<span className="font-serif font-bold">Class Action :-</span><br/>
...
<span className="font-serif font-bold">Suit for Recovery :-</span><br/>

To recover money from someone who owes the same and is not willing to pay back, suit for recovery initiates action through courts. Order 4 of the Civil Procedure Code provides for the same. <br/>


<span className="font-serif font-bold">Suit Against Government :-</span><br/>

The state as well as central government and the corresponding departments are considered as juristic persons for suing and being sued. Hence, types of civil cases under the special category can be done against the government as well as per section 80 of the CPC Code. <br/>


<span className="font-serif font-bold">Property Disputes :-</span><br/>

When it comes to civil disputes, property is said to be the major subject matter. Whether it is for land partition or possession, there are a variety of matters that have the potential of making people each other’s enemy. All such kinds of civil cases are witnessed in the courts.<br/>


<span className="font-serif font-bold">Suit for Declaration of Rights/ Title Suit :-</span><br/>

There are times when the rightful owner of a property is unknown, or there is a dispute regarding who should be the rightful owner among a bunch of people. In such cases, people have to knock on the doors of a civil court to legally analyse who the real owner is. <br/>


<span className="font-serif font-bold">Suit for Eviction :-</span> <br/>

It is usually the matter when a tenant occupying the landlord’s property refuses to leave the premises. Rather than using force, a suit for eviction is lodged in the court to evict the tenant after determining the tenancy. Suppose a property is located in Kolkata and the owner is forcefully evicting the tenant before the term agreed upon, even in such a case the tenant can approach the court through a lawyer in Kolkata. <br/>

<span className="font-serif font-bold">Specific Relief :-</span> <br/>

When the parties to a contract seek some specific act to be performed by the other party in furtherance of the terms agreed upon, or implied, the action is pursued in civil court. The matter is initiated under the Specific Relief Act, 1963. <br/>


<span className="font-serif font-bold">Closure :-</span> <br/>

Civil matters are infamous for taking more and more time. There are some reasons behind the same. First, the judges dealing with civil matters are also the ones who deal with criminal and other matters. Secondly, criminal matters have more risk of infringing the innocent accused rights and tampering with evidence. Hence, they are prioritised over the civil ones. Lastly, civil matters are complex enough for someone to understand quickly just by going through the facts. The above categorization of types of civil cases must have already proven to be a glimpse of such complexity. <br/>
